...
<html class="h-full overflow-y-scroll">
  <head>
    <title>Download Ollama on macOS</title>

    <meta charset="utf-8" />
    <meta name="description" content="Download Ollama for macOS"/>
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <meta property="og:title" content="Download Ollama on macOS" />
    <meta property="og:description" content="Download Ollama for macOS" />
    <meta property="og:url" content="https://ollama.com/download/mac" />
    ...
    <meta property="twitter:title" content="Download Ollama on macOS" />
    <meta property="twitter:description" content="Download Ollama for macOS" />
...
<div id="searchpreview" class="hidden absolute left-0 right-0 top-12 z-50" style="width: calc(100% + 2px); margin-left: -1px;"></div>
  ...
  >
    <a
      class="w-full rounded-3xl bg-neutral-800 px-2 py-2 text-lg text-white hover:bg-black"
      href="/download/Ollama-darwin.zip"
      >Download for macOS</a
    >
    <p class="my-2 text-xs text-neutral-800">
